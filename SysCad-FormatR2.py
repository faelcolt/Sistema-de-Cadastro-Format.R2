...
class Application():
    ...
    def widgets_frame1(self):
        self.bt_limpar=Button(self.frame_1,text="Limpar",bd=3,bg="#107db2",fg="white", font=("verdana",8,"bold"))
        ...
        self.lb_codigo=Label(self.frame_1, text="::: Código :::",bg="lightcyan",fg="#107db2")
